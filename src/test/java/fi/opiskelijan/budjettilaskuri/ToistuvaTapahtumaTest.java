...
assertEquals(2005, 1, 6 , urheiluvaatteet.getAloitusPvm());
}
@Test
...
assertEquals(2006, 11, 7, some.getLopetusPvm());
}
@Test
...
assertEquals(2007, 6, 8, viihde.getViimeksiLuotuPvm());
}
@Test
...
assertEquals(false, riisiruoka.getAktiivinen());
}
@Test
...
assertEquals(2, alusvaatteet.getAktiivinen());
}
}